    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-[#121217] rounded-2xl p-6 border border-gray-100 dark:border-gray-800 shadow-sm relative overflow-hidden group">
            ...
            <div class="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-1.5 mt-2">
                @php
                $rateLimit = (int) \App\Models\Setting::get('platform.api_rate_limit', 60);
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-[#0D0D11] rounded-xl border border-gray-100 dark:border-gray-800">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="api_enabled" value="1" class="sr-only peer" {{ \App\Models\Setting::get('platform.api_enabled', true) ? 'checked' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="number" name="api_rate_limit" value="{{ \App\Models\Setting::get('platform.api_rate_limit', 60) }}" class="block w-full border-gray-200 dark:border-gray-700 dark:bg-[#1A1A22] dark:text-white focus:border-blue-500 focus:ring-blue-500 rounded-xl py-2 px-3 text-sm transition-colors" placeholder="e.g. 60">
                        </div>
                    </div>
