        ...
        <div class="bg-gray-50/50 dark:bg-[#1A1A22]/50 border-b border-gray-200 dark:border-gray-800 mb-8 shadow-sm py-4">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <button @click="activeTab = 'app'" 
                    :class="{'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-400 ring-1 ring-purple-200 dark:ring-purple-800': activeTab === 'app', 'bg-white dark:bg-[#121217] text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-800': activeTab !== 'app'}" 
                    class="flex-shrink-0 px-5 py-2.5 rounded-xl font-bold text-sm transition-all shadow-sm flex items-center gap-2">
                ...
                <button @click="activeTab = 'database'" 
                    :class="{'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-400 ring-1 ring-purple-200 dark:ring-purple-800': activeTab === 'database', 'bg-white dark:bg-[#121217] text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-800': activeTab !== 'database'}" 
                    class="flex-shrink-0 px-5 py-2.5 rounded-xl font-bold text-sm transition-all shadow-sm flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4"></path></svg>
                    Database
                </button>
                <button @click="activeTab = 'mail'" 
                    :class="{'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-400 ring-1 ring-purple-200 dark:ring-purple-800': activeTab === 'mail', 'bg-white dark:bg-[#121217] text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-800': activeTab !== 'mail'}" 
                    class="flex-shrink-0 px-5 py-2.5 rounded-xl font-bold text-sm transition-all shadow-sm flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    Mail (SMTP)
                </button>
                <button @click="activeTab = 'services'" 
                    :class="{'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-400 ring-1 ring-purple-200 dark:ring-purple-800': activeTab === 'services', 'bg-white dark:bg-[#121217] text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-800': activeTab !== 'services'}" 
                    class="flex-shrink-0 px-5 py-2.5 rounded-xl font-bold text-sm transition-all shadow-sm flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"></path></svg>
                    Services
                </button>
                <button @click="activeTab = 'advanced'" 
                    :class="{'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-400 ring-1 ring-purple-200 dark:ring-purple-800': activeTab === 'advanced', 'bg-white dark:bg-[#121217] text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-800': activeTab !== 'advanced'}" 
                    class="flex-shrink-0 px-5 py-2.5 rounded-xl font-bold text-sm transition-all shadow-sm flex items-center gap-2">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-[#121217] rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden p-8 mb-8">
                ...
                <form action="{{ route('admin.settings.update-app') }}" method="POST" enctype="multipart/form-data" class="space-y-12">
                    ...
                    <div class="pt-6 border-t border-gray-100 dark:border-gray-800 flex justify-between items-center rounded-b-2xl">
