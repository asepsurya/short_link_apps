...
<body class="font-sans antialiased text-gray-900 bg-[#FAFAFA] dark:bg-[#0B0B0E] dark:text-white selection:bg-purple-500 selection:text-white min-h-screen flex flex-col overflow-x-hidden">
    ...
    <main class="flex-1 flex flex-col items-center justify-center relative px-4 w-full h-[80vh] min-h-[600px]">
        ...
        <div class="text-center z-10 max-w-5xl mx-auto mt-5">
            ...
            <div x-data="{ 
            ...
            }" class="h-[140px] xs:h-[160px] md:h-[220px] lg:h-[240px] flex items-center justify-center overflow-hidden mb-6 relative">
                <template x-for="(phrase, index) in phrases" :key="index">
                    <div x-show="active === index" 
                        ...
                        class="text-[20px] xs:text-[42px] md:text-[75px] lg:text-[85px] leading-[1.1] font-extrabold tracking-tight text-center">
            ...
            <div class="mt-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl max-w-lg mx-auto flex items-center justify-between">
                ...
                <button onclick="navigator.clipboard.writeText('{{ session('guest_link') }}'); alert('{{ __('Copied!') }}');" class="p-2 bg-white dark:bg-[#121217] rounded shadow-sm border border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
        ...
        <!-- Pricing Section -->
        <section id="pricing" class="container py-24 bg-gray-50/50 dark:bg-[#0D0D11]/50 w-full" style="margin-top: 5rem;">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-4">
                            <div class="p-2 rounded-lg bg-green-100 dark:bg-green-900/30 text-green-600"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></div>
                            <div>
                        ...
                        <div class="flex items-start gap-4">
                            <div class="p-2 rounded-lg bg-blue-100 dark:bg-blue-900/30 text-blue-600"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></div>
                            <div>
